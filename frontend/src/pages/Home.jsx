...
const Home = () => {
  ...
  return (
    <div className="bg-slate-100 py-18 font-inter text-slate-800">
        <div className="mx-auto max-w-6xl">
            ...
            <div className="mb-6">
                ...
                <h1 className="mt-2 font-dm-serif text-4xl text-slate-900 md:text-5xl">
                    Task Management
                </h1>
            ...
            <div className="mb-6 grid gap-4 sm:grid-cols-3">
                ...
                <div className="border border-slate-200 bg-white p-5 shadow-sm">
                    ...
                    <div className="mt-2 flex items-end justify-between">
                        <p className="font-dm-serif text-4xl text-slate-900">
                            {tasks.length}
                        </p>
                ...
                <div className="border border-slate-200 bg-white p-5 shadow-sm">
                    ...
                    <div className="mt-2 flex items-end justify-between">
                        <p className="font-dm-serif text-4xl text-amber-600">
                            {tasks.filter((task) => task.isComplete === "no").length}
                        </p>
                ...
                <div className="border border-slate-200 bg-white p-5 shadow-sm">
                    ...
                    <div className="mt-2 flex items-end justify-between">
                        <p className="font-dm-serif text-4xl text-emerald-600">
                            {tasks.filter((task) => task.isComplete === "yes").length}
                        </p>
            ...
            {/* Main Content */}
            <div className="grid gap-6 lg:grid-cols-[1fr_372px]">
                ...
                <div className="border border-slate-200 bg-white p-6 shadow-sm">
                    ...
                    <div className="mb-5 flex items-center justify-between border-b border-slate-100 pb-4">
                        ...
                        <span className="border border-slate-200 bg-slate-50 px-3 py-1.5 text-xs font-semibold text-slate-600">
    ...
    <div className="border border-dashed border-slate-300 bg-slate-50 px-6 py-12 text-center">
        <p className="font-dm-serif text-xl text-slate-700">
            No tasks yet
        </p>
    ...
    <div className="space-y-6">
        ...
        <div>
            ...
            <div className="space-y-3">
                ...
                {tasks.filter((task) => task.isComplete === "no").length === 0 ? (

                    <div className="border border-dashed border-slate-200 bg-slate-50 px-4 py-6 text-center">
                    ...
                    tasks
                        .filter((task) => task.isComplete === "no")
                        .map((task) => (

                            <div
                                key={task._id}
                                className="flex items-center justify-between gap-4 border border-slate-200 bg-slate-50 p-4 transition hover:border-indigo-200 hover:bg-white"
                            >
                                ...
                                <div className="flex min-w-0 items-center gap-3">
                                    ...
                                    <button
                                        ...
                                        className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full border-2 border-slate-300 bg-white transition hover:border-indigo-400"
        ...
        <div>
            ...
            <div className="mb-3 flex items-center justify-between border-t border-slate-100 pt-5">
                <div className="flex items-center gap-2">
            ...
            <div className="space-y-3">
                ...
                {tasks.filter((task) => task.isComplete === "yes").length === 0 ? (
                    ...
                    tasks
                        .filter((task) => task.isComplete === "yes")
                        .map((task) => (

                            <div
                                key={task._id}
                                className="flex items-center justify-between gap-4 border border-slate-200 bg-slate-50 p-4 transition hover:border-emerald-200 hover:bg-white"
                            >
                ...
                <form
                    ...
                    className="h-fit border border-slate-200 bg-white p-6 shadow-sm"
                >
                    ...
                    <div className="mt-6 flex gap-3">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="flex-1 bg-slate-900 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-indigo-700 disabled:cursor-not-allowed disabled:bg-slate-300"
                        >
                            {loading
                                ? editingId
                                    ? "Updating..."
